...
urlpatterns = [
    ...
    path('joinedtransaction/update/<int:pk>/', views.JoinedTransactionUpdateView.as_view(),
         name='update_joined_transaction'),
    path('joinedtransaction/<int:pk>/', views.JoinedTransactionsDetailView.as_view(),
